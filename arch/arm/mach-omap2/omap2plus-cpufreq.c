...
#define MIN_OMAP4430_VDD_CORE_OPP50_UV		1025000
#define MIN_OMAP4430_VDD_CORE_OPP100_UV		1200000
	...
	const char *buf, size_t count)
{
	...
	for(i--; i >= 0; i--) {
		if(freq_table[i].frequency != CPUFREQ_ENTRY_INVALID) {
			...
			case MIN_OMAP4430_VDD_CORE_OPP50_UV:
				if (opp_cur->u_volt < MIN_OMAP4430_VDD_CORE_OPP50_UV)
					opp_cur->u_volt = MIN_OMAP4430_VDD_CORE_OPP50_UV;
				break;
			case MIN_OMAP4430_VDD_CORE_OPP100_UV:
				if (opp_cur->u_volt < MIN_OMAP4430_VDD_CORE_OPP100_UV)
					opp_cur->u_volt = MIN_OMAP4430_VDD_CORE_OPP100_UV;
				break;
			default:
...
bad_uv_err:
	...
	pr_warn("User voltage control activated!\n");
